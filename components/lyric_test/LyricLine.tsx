  ...
  return (
    <div ref={divRef} className="w-fit min-w-65 h-fit relative group">
      ...
      <div
        ...
        translate-y-2 rotate-x-90 blur-sm
        group-hover:translate-y-0 group-hover:rotate-x-0 group-hover:blur-none
        pointer-coarse:translate-y-0 pointer-coarse:rotate-x-0 pointer-coarse:blur-none
        transition-all"
      >
